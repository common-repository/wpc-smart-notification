...
class FromBuilding {
	...
	function set( $args = [] ) {
		...
		$this->is_widget    = ! empty( $args['is_widget'] ) ? true : false;
	...
	public function building() {
		$unique_id = $this->is_widget ? $this->implode_field_id( $this->field_id ) : $this->unique_id( $this->name_prefix . '-' );

		echo '<div id="', $unique_id, '" class="', $this->name_prefix, '-form-content', ! $this->is_widget ? ' attach' : '', '">
		...
		if ( $this->is_widget && $this->number != '__i__' ) {
